<%@ Page Title="Haircuts" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeFile="haircut.aspx.cs" Inherits="WebApplication1.haircut" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <h2 style="text-align:center;">Men's Haircuts</h2>
    <div class="image-gallery">
        <asp:Repeater ID="rptHaircuts" runat="server">
            <ItemTemplate>
